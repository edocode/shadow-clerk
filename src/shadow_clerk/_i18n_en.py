...
STRINGS_EN: dict[str, str] = {
    ...
    "dash.font_m": "M",
    "dash.font_l": "L",
    "dash.console_launch": "Launch",
    "dash.console_launch_title": "Start the assistant without sending the initial prompt (for /resume)",
    "dash.console_stop": "Stop",
    ...
    "dash.workdir_title": "Working directory for this meeting",
    "dash.workdir_pattern": "Meeting name pattern (regex)",
    "dash.workdir_pattern_hint": "Meeting names vary (Board_Meeting / Board MTG). Loosen the pattern so it matches all of them.",
    "dash.workdir_path": "Working directory",
    "dash.workdir_default": "Default: {path}",
    "dash.workdir_file": "Config file: {path}",
    "dash.workdir_delete": "Delete rule",
    "dash.workdir_saved": "Saved.",
    "dash.workdir_btn_title": "Set the working directory for this meeting",
    "dash.summary_reload": "Reload summary",
    "dash.summary_copy": "Copy as Markdown",
    ...
    "dash.help_body": (
        ...
        "  The right one starts folded. Your browser remembers either state.\n\n"
    ...
    "cfg.auto_analyze": "Start analysis with the meeting",
    "cfg.forbid_analyze": "Topics to leave alone",
    "cfg.forbid_analyze_hint": "Listed topics are excluded from AI analysis. Empty means no restriction.",
    "cfg.forbid_analyze_free": "Other (one per line)",
    "cfg.forbid_preset.evaluation": "Performance reviews",
    "cfg.forbid_preset.compensation": "Pay and grading",
    "cfg.forbid_preset.private": "Private matters (marriage, childbirth, health)",
    "cfg.forbid_preset.hiring": "Hiring and departures",
    "cfg.forbid_preset.legal": "Legal and disputes",
    "cfg.ai_assistant_command": "Assistant command",
